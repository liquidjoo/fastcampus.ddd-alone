...
public class ApiPokemonRepository implements PokemonRepository {
    @Override
    public Pokemon findById(final NationalPokedexNumber nationalPokedexNumber) {
        final PokeApiClient pokeApiClient = new PokeApiClient();
        final PokemonSpecies pokemonSpecies = pokeApiClient.getPokemonSpecies(nationalPokedexNumber.toInt());
